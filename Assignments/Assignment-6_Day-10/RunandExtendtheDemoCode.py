...
# Extension 1
    ...
    def publish(self):
        ...
        print(f"'{self.title}' is Live Now")
    ...
    def summary(self):
        ...
        print(f"Q_COUNT : {self.question_count()}")   # using new method
...
python_quiz = Test("Python Basic Quiz", "Ravi Sir", 30)
...
print("Total Questions:", python_quiz.question_count())
